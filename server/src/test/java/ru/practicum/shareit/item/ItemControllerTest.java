...
import ru.practicum.shareit.item.ItemController.ItemController;
...
public class ItemControllerTest {
    ...
    void getItemsByUserId() throws Exception {
        when(itemService.getItems(nullable(Integer.class), nullable(Integer.class), any(Long.class)))
    ...
    void editItem() throws Exception {
        when(itemService.editItem(any(), any(Long.class), any(Long.class)))
                .thenReturn(itemDto);
